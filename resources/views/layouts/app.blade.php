...
<head>
    ...
    <link href="{{ asset('node_modules/angularjs-toaster/toaster.min.css') }}" rel="stylesheet">
</head>
<body ng-app="app">
    <div id="app" ng-controller="tripCtrl">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="app-navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        @else
                            <li >
                                <a href="#" data-toggle="modal" data-target="#myModal"  ng-click="newTrip(form.trip)"  >
                                    Nueva Ruta <span class="glyphicon glyphicon-plus"></span>
                                </a>
                            </li>
                            <li class="dropdown">
